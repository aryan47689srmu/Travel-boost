...
export default function TravelServices() {
  ...
  async function load() {
    const { data } = await api.get("/travel-services", { params: { destination, type } });
    setServices(data);
  }
